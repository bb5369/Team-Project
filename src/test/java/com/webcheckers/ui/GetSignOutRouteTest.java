...
public class GetSignOutRouteTest {
    ...
    public void setup(){
        ...
        playerNormal = new Player("Norm", Player.GameType.NORMAL);
        playerTourn = new Player("Norm", Player.GameType.TOURNAMENT);
    ...
    public void notInPlayerLobbyGameNotNull() {
        ...
        game = new CheckersGame(playerRed, playerNormal);
